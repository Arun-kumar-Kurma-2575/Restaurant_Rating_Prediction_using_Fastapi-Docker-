...
if st.button('🔮 Predict Rating'):
     input_data={"country_code_encoded":country_code_encoded,"city_encoded":city_encoded, 
              "Average_Cost_for_two":Average_Cost_for_two, 
              "currency_encoded":currency_encoded,
        "table_booking_encoded":table_booking_encoded,
          "online_delivery_encoded": online_delivery_encoded,
            "price_range_encoded":price_range_encoded,
        "Rating_color_encoded":Rating_color_encoded,
          "rating_text_encoded":rating_text_encoded, 
          "votes":votes,
     ...
     try:
        ...
        if response.status_code==200:
               ...
               st.error(f"APT_ERROR:{response.status_code}-{response.text}")
